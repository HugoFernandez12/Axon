    ...
    if(len(data)!=0):
        if request.form.get("aregarAmigo")=="Agregar":
            ...
            try:
                ...
                error="No se encontro a "+nombreAmigo
                log.error("ERROR: No se encontro a "+nombreAmigo+".")
    #------------------------------------------------#
...
def crearGrupo():
    ...
    #--Si no tienes una sesion iniciada te redirige--#
    #--      a la pagina de inicio de sesion       --#
    global usuarioConectado,arrayAmigoGrupo,lenghtAmigosGrupo,error,nombreGrupo,mensajeControl
    if usuarioConectado=="":
        return redirect("/")
    #------------------------------------------------#
    ...
    return render_template('axon8.html',mensajeControl=mensajeControl,nombreGrupo=nombreGrupo,error=error,
                           ...
                           lenghtAmigosGrupo=lenghtAmigosGrupo,arrayTemas=arrayTemas)
#----------------------------------------------------------------------
...
def preguntasAdmin():
    ...
    #--Si no tienes una sesion iniciada te redirige--#
    #--      a la pagina de inicio de sesion       --#
    global usuarioConectado,error,mensajeControl,idPreguntaConsulta,controlFiltroTema,arrayIdPregunta,arrayPregunta
    if usuarioConectado!="admin":
        return redirect("/")
    error=""
    mensajeControl=""
    ...
    return render_template('axon13.html',error=error,mensajeControl=mensajeControl,arrayPregunta=arrayPregunta,
                           lenghtPregunta=lenghtPregunta,arrayTemas=arrayTemas)
#----------------------------------------------------------------------
...
def preguntaConsultaAdmin():
    ...
    #--Si no tienes una sesion iniciada te redirige--#
    #--      a la pagina de inicio de sesion       --#
    global usuarioConectado,error,mensajeControl,idPreguntaConsulta,controlFiltroTema
    if usuarioConectado!="admin":
        return redirect("/")
    error=""
    mensajeControl=""
